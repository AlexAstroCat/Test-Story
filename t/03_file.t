...
Basic_usage: {
    ...
    ok(Test::Story::File->meta->has_attribute('config'), q{config attribute});
...
Invalid_Syntax: {
    ...
    isa_ok($file, 'Test::Story::File', q{Created File object for invalid_syntax.tc});
