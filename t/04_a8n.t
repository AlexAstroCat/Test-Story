...
Basic_usage: {
    ...
    ok( Test::Story->meta->has_attribute('config'), q{config attribute}) ;
...
Invalid_syntax: {
    ...
    } "Creating a Test::Story object with an invalid testcase doesn't die";
    isa_ok($obj, 'Test::Story', q{object constructed}) ;
}
