...
Test::Story::File - Storytest file object
...
files.  For more information, please see L<Test::Story>.
...
See L<Test::Story/fixture_base>.

=item file_root

See L<Test::Story/file_root>.

=item verbose

See L<Test::Story/verbose>.

=item testcase_class

Used to set the class used to store testcases.

Default: L<Test::Story::TestCase>
...
L<Test::Story::TestCase>, L<Test::FITesque::Test>
